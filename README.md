# @discere-os/libsndfile.wasm

WebAssembly port of libsndfile - Audio file I/O library with comprehensive format support including WAV, FLAC, OGG, and professional audio formats with SIMD optimization.

[![CI/CD](https://github.com/discere-os/discere-nucleus/actions/workflows/libsndfile-wasm-ci.yml/badge.svg)](https://github.com/discere-os/discere-nucleus/actions)
[![JSR](https://jsr.io/badges/@discere-os/libsndfile.wasm)](https://jsr.io/@discere-os/libsndfile.wasm)
[![npm version](https://badge.fury.io/js/@discere-os%2Flibsndfile.wasm.svg)](https://badge.fury.io/js/@discere-os%2Flibsndfile.wasm)
